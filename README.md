# Awesome Countries Indices [![Awesome](https://awesome.re/badge.svg)](https://awesome.re)

> A curated list of indices, rankings, and statistical data sources about countries worldwide.

Covers economic, social, political, environmental, military, and cultural metrics. Each source includes a description of available data.

## Contents

- [Aggregators & Databases](#aggregators--databases)
- [Human Development & Quality of Life](#human-development--quality-of-life)
- [Economy & Finance](#economy--finance)
- [Demographics & Population](#demographics--population)
- [Democracy, Freedom & Human Rights](#democracy-freedom--human-rights)
- [Corruption & Governance](#corruption--governance)
- [Peace, Security & Crime](#peace-security--crime)
- [Military & Defense](#military--defense)
- [Happiness & Subjective Wellbeing](#happiness--subjective-wellbeing)
- [Education](#education)
- [Health & Medicine](#health--medicine)
- [Environment & Climate](#environment--climate)
- [Energy](#energy)
- [Technology, Innovation & Digitalization](#technology-innovation--digitalization)
- [Gender Equality](#gender-equality)
- [Migration & Refugees](#migration--refugees)
- [Tourism, Passports & Visas](#tourism-passports--visas)
...
- [World Bank Open Data](https://data.worldbank.org/) — Largest open aggregator. Metrics: GDP, inflation, poverty, population, education, healthcare, energy, trade, employment (~1,400 indicators).
- [UN Data](https://data.un.org/) — UN data portal. Metrics: demography, crime, trade, production, gender, education, energy.
- [OECD Data](https://data.oecd.org/) — OECD countries + partners. Metrics: economy, innovation, taxes, health, migration, inequality, productivity.
- [Our World in Data](https://ourworldindata.org/) — Visualizations + datasets. Metrics: health, climate, poverty, war, nutrition, technology (thousands of datasets).
- [Gapminder](https://www.gapminder.org/data/) — Historical series from 19th century. Metrics: income, life expectancy, child mortality, population.
- [Statista](https://www.statista.com/) — Paid aggregator. Metrics: markets, consumption, industries, surveys (80k+ sources).
- [Trading Economics](https://tradingeconomics.com/) — Real-time macroeconomics. Metrics: GDP, inflation, interest rates, labor markets, stock markets, bonds.
- [Knoema](https://knoema.com/) — Dataset aggregator. Metrics: economy, industries, regional statistics.
- [CEIC Data](https://www.ceicdata.com/) — Paid macrodata. Metrics: 200+ countries, high-frequency indicators.
- [IMF Data](https://www.imf.org/en/Data) — IMF portal. Metrics: WEO forecasts, balance of payments, government debt, reserves, exchange rates.
- [Eurostat](https://ec.europa.eu/eurostat) — EU statistics. Metrics: economy, social statistics, agriculture, transport, environment across EU.
- [CIA World Factbook](https://www.cia.gov/the-world-factbook/) — Country profiles. Metrics: geography, demography, economy, government, military, communications.
...
- [Human Development Index (UNDP)](https://hdr.undp.org/data-center/human-development-index) — HDI. Metrics: life expectancy, education, GNI per capita. Also IHDI (inequality-adjusted), GDI, GII, MPI.
- [Legatum Prosperity Index](https://www.prosperity.com/) — 12 pillars of prosperity. Metrics: safety, freedom, governance, social capital, investment environment, health, education.
- [Social Progress Index](https://www.socialprogress.org/) — GDP-independent measure. Metrics: basic human needs, foundations of wellbeing, opportunity.
- [Quality of Life Index (Numbeo)](https://www.numbeo.com/quality-of-life/rankings_by_country.jsp) — Crowdsourced. Metrics: purchasing power, safety, healthcare, climate, traffic, pollution.
- [Mercer Quality of Living](https://www.mercer.com/insights/total-rewards/talent-mobility-insights/quality-of-living-city-ranking/) — City-level. Metrics: political environment, social environment, economy, healthcare, education, transport.
- [Better Life Index (OECD)](https://www.oecdbetterlifeindex.org/) — 11 topics. Metrics: housing, income, jobs, education, health, environment, work-life balance.
- [Where-to-be-born Index (EIU)](https://en.wikipedia.org/wiki/Where-to-be-born_Index) — Forecasted quality of life at birth.
- [Good Country Index](https://index.goodcountry.org/) — How much each country contributes to global good. Metrics: science & technology, culture, international peace & security, world order, planet & climate, prosperity & equality, health & wellbeing.
...
- [IMF World Economic Outlook](https://www.imf.org/en/Publications/WEO) — GDP, inflation, unemployment, government debt, current account, forecasts.
- [World Bank World Development Indicators](https://databank.worldbank.org/source/world-development-indicators) — WDI. Metrics: economy, poverty, trade, FDI.
- [Doing Business (archive)](https://archive.doingbusiness.org/) — Closed 2021. Metrics: business registration, permits, taxes, cross-border trade, enforcing contracts.
- [Business Ready (B-READY, World Bank)](https://www.worldbank.org/en/businessready) — Doing Business successor. Metrics: regulatory environment, public services, operational efficiency.
- [Global Competitiveness Index (WEF, archive)](https://www.weforum.org/reports/the-global-competitiveness-report-2020) — 12 pillars of competitiveness.
- [IMD World Competitiveness Ranking](https://www.imd.org/centers/wcc/world-competitiveness-center/rankings/world-competitiveness-ranking/) — Economic performance, government efficiency, business efficiency, infrastructure.
- [Heritage Economic Freedom Index](https://www.heritage.org/index/) — Economic freedom. Metrics: rule of law, government size, regulatory efficiency, open markets.
- [Fraser Economic Freedom of the World](https://www.fraserinstitute.org/economic-freedom) — Similar to Heritage. 5 areas.
- [Gini Index (World Bank)](https://data.worldbank.org/indicator/SI.POV.GINI) — Income inequality.
- [World Inequality Database](https://wid.world/) — Income/wealth distribution, top 1%, top 10%.
- [UBS Global Wealth Report](https://www.ubs.com/global/en/family-office-uhnw/reports/global-wealth-report.html) — Household wealth, millionaires, ultra-high-net-worth.
- [Big Mac Index (Economist)](https://www.economist.com/big-mac-index) — PPP via burger price.
- [Numbeo Cost of Living](https://www.numbeo.com/cost-of-living/) — Prices, rent, groceries, transport by city.
- [Expatistan](https://www.expatistan.com/cost-of-living) — City cost-of-living comparison.
- [Forbes Global 2000](https://www.forbes.com/lists/global2000/) — Largest public companies.
- [Fortune Global 500](https://fortune.com/ranking/global500/) — Largest by revenue.
- [S&P Global Ratings / Moody's / Fitch](https://www.spglobal.com/ratings/en/) — Sovereign credit ratings.
...
- [UN World Population Prospects](https://population.un.org/wpp/) — Projections to 2100. Metrics: population, birth rates, mortality, migration, age structure.
- [UN DESA Population Division](https://www.un.org/development/desa/pd/) — Urbanization, migration, aging.
- [Worldometer](https://www.worldometers.info/) — Real-time population, growth rates.
- [PopulationPyramid.net](https://www.populationpyramid.net/) — Age pyramids 1950–2100.
- [US Census International Database](https://www.census.gov/data-tools/demo/idb/) — Demographics for 227 countries.
- [Eurostat Demography](https://ec.europa.eu/eurostat/web/population-demography) — Detailed EU data.
- [DHS Program](https://dhsprogram.com/) — Health and demographic surveys for developing countries.

## Democracy, Freedom & Human Rights

- [Freedom House — Freedom in the World](https://freedomhouse.org/report/freedom-world) — Political rights (1–40), civil liberties (1–60). Categories: Free / Partly Free / Not Free.
- [Freedom House — Freedom on the Net](https://freedomhouse.org/report/freedom-net) — Internet freedom.
- [Freedom House — Nations in Transit](https://freedomhouse.org/report/nations-transit) — Post-communist countries.
- [EIU Democracy Index](https://www.eiu.com/n/campaigns/democracy-index/) — Full/flawed democracy, hybrid, authoritarian. 60 indicators.
- [V-Dem (Varieties of Democracy)](https://v-dem.net/) — 500+ democracy indicators since 1789. Metrics: electoral, liberal, participatory, deliberative, egalitarian.
- [Polity Project](https://www.systemicpeace.org/polityproject.html) — Autocracy/democracy score –10 to +10.
- [Bertelsmann Transformation Index (BTI)](https://bti-project.org/) — Political and economic transformation.
- [Human Freedom Index (Cato/Fraser)](https://www.cato.org/human-freedom-index) — Personal + economic freedoms.
- [CIVICUS Monitor](https://monitor.civicus.org/) — Civil society freedom (open/narrowed/obstructed/repressed/closed).
- [Amnesty International Reports](https://www.amnesty.org/en/countries/) — Human rights country profiles.
...
- [Transparency International — Corruption Perceptions Index](https://www.transparency.org/en/cpi) — CPI, 0–100.
- [World Bank — Worldwide Governance Indicators](https://info.worldbank.org/governance/wgi/) — WGI. 6 dimensions: voice & accountability, political stability, government effectiveness, regulatory quality, rule of law, corruption control.
- [Global Corruption Barometer](https://www.transparency.org/en/gcb) — Citizen surveys on corruption experience.
- [Basel AML Index](https://index.baselgovernance.org/) — Money laundering risk.
...
- [Global Peace Index (IEP)](https://www.visionofhumanity.org/maps/) — 163 countries. Metrics: domestic conflicts, militarization, societal safety.
- [Global Terrorism Index (IEP)](https://www.visionofhumanity.org/maps/global-terrorism-index/) — Terrorist incidents, casualties, economic impact.
- [Fragile States Index (Fund for Peace)](https://fragilestatesindex.org/) — State fragility. 12 indicators.
- [Armed Conflict Database (IISS)](https://www.iiss.org/publications/armed-conflict-database) — Active conflicts.
- [UCDP (Uppsala Conflict Data Program)](https://ucdp.uu.se/) — Conflict dataset 1946–present.
- [ACLED](https://acleddata.com/) — Political violence and protest events.
- [UNODC Statistics](https://dataunodc.un.org/) — Crime: homicides, theft, drugs, trafficking.
- [Numbeo Crime Index](https://www.numbeo.com/crime/rankings_by_country.jsp) — Crowdsourced crime perception.
...
- [SIPRI Military Expenditure Database](https://www.sipri.org/databases/milex) — Military spending since 1949.
- [SIPRI Arms Transfers Database](https://www.sipri.org/databases/armstransfers) — Arms exports/imports.
- [Global Firepower](https://www.globalfirepower.com/) — Military power index. Metrics: manpower, equipment, finances, geography, logistics.
- [IISS Military Balance](https://www.iiss.org/publications/the-military-balance) — Armed forces composition.
- [NTI Nuclear Security Index](https://www.ntiindex.org/) — Nuclear materials security.
- [Bulletin of Atomic Scientists — Nuclear Notebook](https://thebulletin.org/nuclear-notebook-multimedia/) — Nuclear arsenal estimates.

## Happiness & Subjective Wellbeing

- [World Happiness Report](https://worldhappiness.report/) — Life evaluation (Cantril ladder). Metrics: GDP, social support, healthy life expectancy, freedom, generosity, corruption.
- [Gallup World Poll](https://www.gallup.com/analytics/318875/global-research.aspx) — Surveys in 150+ countries.
...
- [PISA (OECD)](https://www.oecd.org/pisa/) — 15-year-olds: math, reading, science.
- [TIMSS](https://timssandpirls.bc.edu/timss-landing.html) — Math/science, grades 4 and 8.
- [PIRLS](https://timssandpirls.bc.edu/pirls-landing.html) — Reading, grade 4.
- [UNESCO Institute for Statistics](http://uis.unesco.org/) — Literacy, enrollment, spending, teachers.
- [QS World University Rankings](https://www.topuniversities.com/university-rankings) — Universities.
- [Times Higher Education Rankings](https://www.timeshighereducation.com/world-university-rankings) — Universities.
- [ARWU (Shanghai Ranking)](https://www.shanghairanking.com/) — Academic rankings.
...
- [WHO Global Health Observatory](https://www.who.int/data/gho) — Mortality, diseases, vaccination, government health spending.
- [IHME Global Burden of Disease](https://www.healthdata.org/research-analysis/gbd) — Causes of death, DALYs, YLL, YLD.
- [Global Health Security Index](https://www.ghsindex.org/) — Pandemic preparedness.
- [Bloomberg Health-Efficient Countries](https://www.bloomberg.com/) — Healthcare efficiency.
- [Numbeo Health Care Index](https://www.numbeo.com/health-care/rankings_by_country.jsp) — Perception of healthcare systems.
- [OECD Health Statistics](https://www.oecd.org/health/health-statistics.htm) — Spending, life expectancy, physicians, hospital beds.
- [UNAIDS](https://www.unaids.org/en/resources/fact-sheet) — HIV/AIDS data.
- [Global Fund Data](https://data.theglobalfund.org/) — HIV, TB, malaria.
...
- [Environmental Performance Index (Yale)](https://epi.yale.edu/) — EPI. 40+ indicators: climate, air quality, water, biodiversity.
- [Climate Change Performance Index (CCPI)](https://ccpi.org/) — Climate policy performance.
- [ND-GAIN Country Index](https://gain.nd.edu/our-work/country-index/) — Climate change vulnerability + readiness.
- [Global Forest Watch](https://www.globalforestwatch.org/) — Forests, deforestation.
- [World Air Quality Index](https://www.iqair.com/world-most-polluted-countries) — PM2.5, air pollution.
- [WWF Living Planet Report](https://livingplanet.panda.org/) — Biodiversity.
- [Global Footprint Network](https://www.footprintnetwork.org/) — Ecological footprint, Earth Overshoot Day.
- [Climate Watch](https://www.climatewatchdata.org/) — Greenhouse gas emissions, NDCs.
- [EDGAR (EU)](https://edgar.jrc.ec.europa.eu/) — Emissions by country and sector.
- [Global Carbon Atlas](http://www.globalcarbonatlas.org/) — CO2 emissions.
- [Aqueduct (WRI)](https://www.wri.org/aqueduct) — Water stress.
...
- [IEA Data](https://www.iea.gov/data-and-statistics) — Energy production, consumption, imports/exports.
- [Energy Institute Statistical Review of World Energy](https://www.energyinst.org/statistical-review) — Formerly BP. Metrics: oil, gas, coal, electricity, renewables.
- [IRENA Statistics](https://www.irena.org/Data) — Renewable energy data.
- [EIA International Energy Statistics](https://www.eia.gov/international/data/world) — US EIA global energy data.
...
- [Global Innovation Index (WIPO)](https://www.wipo.int/global_innovation_index/) — GII. 80+ indicators: institutions, human capital, infrastructure, market, business, knowledge, creativity.
- [Bloomberg Innovation Index](https://www.bloomberg.com/) — R&D intensity, manufacturing, patent activity.
- [ITU ICT Development Index](https://www.itu.int/en/ITU-D/Statistics/Pages/IDI/default.aspx) — ICT access and use.
- [UN E-Government Survey](https://publicadministration.un.org/egovkb/en-us/Reports/UN-E-Government-Survey-2022) — EGDI. Online services, telecom infrastructure, human capital.
- [Network Readiness Index (Portulans)](https://networkreadinessindex.org/) — Readiness for networked economy.
- [DESI (EU)](https://digital-strategy.ec.europa.eu/en/policies/desi) — Digital Economy and Society Index (EU only).
- [Speedtest Global Index (Ookla)](https://www.speedtest.net/global-index) — Internet speeds.
- [Cloudflare Radar](https://radar.cloudflare.com/) — Internet traffic, BGP, attacks.
- [GitHub Octoverse](https://octoverse.github.com/) — Developers and projects by country.
- [Stack Overflow Developer Survey](https://survey.stackoverflow.co/) — Salaries, technologies by country.
- [AI Index (Stanford HAI)](https://aiindex.stanford.edu/) — AI progress by country.
- [Government AI Readiness Index](https://oxfordinsights.com/ai-readiness/ai-readiness-index/) — Government sector AI readiness.
- [World Digital Competitiveness Ranking (IMD)](https://www.imd.org/centers/wcc/world-competitiveness-center/rankings/world-digital-competitiveness-ranking/) — Digital competitiveness.
- [Global Cybersecurity Index (ITU)](https://www.itu.int/en/ITU-D/Cybersecurity/pages/global-cybersecurity-index.aspx) — GCI. Cybersecurity commitment across 5 pillars: legal, technical, organizational, capacity development, cooperation.
...
- [WEF Global Gender Gap Report](https://www.weforum.org/reports/global-gender-gap-report-2023/) — Economic participation, education, health, political empowerment.
- [UN Gender Inequality Index](https://hdr.undp.org/gender-inequality-index) — GII. Reproductive health, empowerment, labor market.
...
- [UN DESA International Migrant Stock](https://www.un.org/development/desa/pd/content/international-migrant-stock) — Migrants by country of origin/destination.
- [UNHCR Refugee Data Finder](https://www.unhcr.org/refugee-statistics/) — Refugees, stateless persons, IDPs.
- [IOM Migration Data Portal](https://www.migrationdataportal.org/) — Global migration.
...
- [UNWTO Tourism Data](https://www.unwto.org/tourism-data/global-and-regional-tourism-performance) — Arrivals, tourism revenues.
- [Henley Passport Index](https://www.henleyglobal.com/passport-index) — Passport strength. Visa-free access count.
- [Nomad Passport Index](https://nomadcapitalist.com/nomad-passport-index/) — Visas + taxation + quality of life.
...
- [RSF World Press Freedom Index](https://rsf.org/en/index) — Press freedom.
- [Freedom House Freedom on the Net](https://freedomhouse.org/report/freedom-net) — Internet freedom.
- [CPJ Journalists Killed](https://cpj.org/) — Killed/imprisoned journalists.
- [Reuters Digital News Report](https://reutersinstitute.politics.ox.ac.uk/digital-news-report) — News consumption by country.
- [DataReportal Digital Reports](https://datareportal.com/) — Internet/social media by country.
- [StatCounter Global Stats](https://gs.statcounter.com/) — Browser, OS, search engine market shares.
- [Internet World Stats](https://www.internetworldstats.com/) — Internet penetration.

## Culture, Religion & Languages

- [Hofstede Insights — Country Comparison](https://www.hofstede-insights.com/country-comparison-tool) — Cultural dimensions: power distance, individualism, masculinity, uncertainty avoidance, long-term orientation, indulgence.
- [World Values Survey](https://www.worldvaluessurvey.org/) — Inglehart-Welzel cultural map.
- [Pew Research — Religion](https://www.pewresearch.org/religion/) — Religious composition.
- [Ethnologue](https://www.ethnologue.com/) — World languages, speakers.
- [Glottolog](https://glottolog.org/) — Languages, language families.
- [Joshua Project](https://joshuaproject.net/) — Ethnic groups, religions.
- [UNESCO World Heritage List](https://whc.unesco.org/en/list/) — World Heritage Sites by country.
- [Nation Brands Index (Anholt-Ipsos)](https://www.ipsos.com/en/nation-brands-index) — Country image/brand.
...
- [FAOSTAT](https://www.fao.org/faostat/) — Production, trade, food security, land use, fertilizers, livestock.
- [Global Hunger Index](https://www.globalhungerindex.org/) — Hunger: undernourishment, child wasting, child mortality.
...
- [ICAO Air Transport Statistics](https://www.icao.int/sustainability/Pages/Air-Traffic-Statistics.aspx) — Air traffic.
- [IATA](https://www.iata.org/en/publications/economics/) — Aviation economics.
- [UIC Railway Statistics](https://uic.org/support-activities/statistics/) — Railways.
- [World Bank Logistics Performance Index](https://lpi.worldbank.org/) — LPI: customs, infrastructure, international shipments, service quality.
- [INRIX Global Traffic Scorecard](https://inrix.com/scorecard/) — Urban traffic congestion.
- [TomTom Traffic Index](https://www.tomtom.com/traffic-index/) — Traffic congestion.

## Taxes & Business

- [PwC/World Bank Paying Taxes (archive)](https://www.pwc.com/gx/en/services/tax/publications/paying-taxes-2020.html) — Tax burden (archived).
- [KPMG Corporate Tax Rates Table](https://kpmg.com/xx/en/home/services/tax/tax-tools-and-resources/tax-rates-online/corporate-tax-rates-table.html) — Corporate tax rates.
- [OECD Tax Database](https://www.oecd.org/tax/tax-policy/tax-database/) — Tax rates, tax revenues.
- [Tax Foundation International Tax Competitiveness Index](https://taxfoundation.org/research/all/global/international-tax-competitiveness-index/) — OECD tax competitiveness.
...
- [Natural Earth](https://www.naturalearthdata.com/) — Free vector/raster maps.
- [GADM](https://gadm.org/) — Administrative boundaries.
- [OpenStreetMap](https://www.openstreetmap.org/) — Open maps.
- [GeoNames](https://www.geonames.org/) — Geographic names, country codes.
- [ISO 3166 codes](https://www.iso.org/iso-3166-country-codes.html) — Country codes.
- [UN M49](https://unstats.un.org/unsd/methodology/m49/) — UN regions and codes.

## Open APIs & Data Libraries

- [REST Countries](https://restcountries.com/) — REST API: capitals, currencies, languages, borders, flags.
- [World Bank API](https://datahelpdesk.worldbank.org/knowledgebase/topics/125589) — 16k indicators.
- [IMF SDMX API](https://datahelp.imf.org/knowledgebase/articles/667681-using-the-imf-s-sdmx-web-service-api) — IMF data.
- [OECD SDMX API](https://data.oecd.org/api/) — OECD API.
- [Eurostat API](https://ec.europa.eu/eurostat/web/query-builder/bulk-downloads) — EU data.
- [UN Comtrade](https://comtradeplus.un.org/) — Trade flows.
- [Trade Map (ITC)](https://www.trademap.org/) — Trade, tariffs.
- [OEC (Observatory of Economic Complexity)](https://oec.world/) — Trade visualization + Economic Complexity Index.
- [Wikidata](https://www.wikidata.org/) — Structured data.
- [countriesnow.space](https://countriesnow.space/) — Free API: cities, regions, flags, codes.
- [Country.io](http://country.io/) — ISO codes, continents, names.
- [pycountry](https://pypi.org/project/pycountry/) — Python library for ISO codes.

---

## Contributing

PRs welcome. Follow the [awesome-list guidelines](https://github.com/sindresorhus/awesome/blob/main/awesome.md). Format:
`- [Name](url) — short description. Metrics: a, b, c.`
